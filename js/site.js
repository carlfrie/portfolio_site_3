/* g maps api key
    AIzaSyD550VenXwwkDupXIJi3y2YXGDzMLmS0Hc
*/
...
function initMap(){
  ...
  var options = {
    zoom:10,
    center: {lat:13.7056,lng:100.6011}
  };
  // New map
  ...
  var marker = new google.maps.Marker({
    position:{lat:13.6799,lng:100.6096},
    map:map
  });

  // Info window
 var infoWindow = new google.maps.InfoWindow({
   content:'<h3>Udom Suk</h3>'
 });
